...
export function StoreSwitcher({ className, items, currentItem }: StoreSwitcherProps) {

      const router = useRouter();
      const { onOpen } = useStoreModal();
      const [open, setOpen] = React.useState(false);
      const [selectedStore, setSelectedStore] = React.useState<StoreSelectItem>(currentItem)
